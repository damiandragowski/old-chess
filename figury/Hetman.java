...
public class Hetman extends Figura {
    ...
    private static ImageIcon f_b = new javax.swing.ImageIcon(ClassLoader.getSystemResource("figury/gif/b_hetman.gif")); 
    private static ImageIcon f_c = new javax.swing.ImageIcon(ClassLoader.getSystemResource("figury/gif/c_hetman.gif")); 
    
    /** Creates a new instance of Hetman */
    public Hetman(boolean biale) {
    ...
    public int zbadajRuchBezKrola(Point p1, Point p2, Figura[][] f) {
        ...
        if ((Math.abs(p1.x-p2.x) != Math.abs(p1.y-p2.y)) && (dx!=0 && dy!=0)) return Szachownica.RUCH_NIEDOZWOLONY;
